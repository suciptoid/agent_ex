              ...
              >
                ...
                <div class="flex items-center justify-between gap-4 pt-1">
                  <.link
                    ...
                    class="text-sm font-medium text-slate-600 transition hover:text-slate-900 dark:text-slate-300 dark:hover:text-slate-100"
                  >
                    Forgot password?
                  </.link>
                  <.button class="rounded-xl px-6 transition hover:brightness-95 dark:hover:brightness-110">
                    Log in
                  </.button>
                </div>
              </.form>
